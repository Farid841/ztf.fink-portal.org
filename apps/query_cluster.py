...
def submit_job(
    ...
    if extra_cond is not None:
        [job_args.append(f"-extraCond={elem.strip()}") for elem in extra_cond.split(";")]
    ...
    if inf_model_select and trans_datasource == "ZTF":
        ...
        try:
            ...
            logging.warning("[Inference] K8s job creation error:\n%s", traceback.format_exc())
                ...
                children=[
                    ...
                    dmc.GridCol(
                        children=[
                                ...
                                children=[
                                    ...
                                    dmc.StepperStep(
                                        ...
                                        children=html.Div(
                                            [
                                                dmc.Space(h=50),
                                                dmc.Divider(variant="solid", label="Launch"),
                                                dmc.Space(h=20),
                                                dmc.Grid(
                            ...
                            html.Div("", id="inf-topic-store", style={"display": "none"}),
                        ],
                        span=9,
                    ),
                ],
